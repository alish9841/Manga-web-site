...
<section class="checkout">
    <form action="esewa/process_esewa.php" method="POST">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                <span>city :</span>
                <input type="text" name="city" placeholder="e.g. ktm">
            </div>
            <div class="inputBox">
                <span>state :</span>
                <input type="text" name="state" placeholder="e.g. ktm">
            </div>
            <div class="inputBox">
                <span>country :</span>
        ...
        <input type="hidden" name="amount" value="<?php echo $grand_total;?>"id="amount" required>
